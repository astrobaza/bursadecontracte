...
<div class="col-md-4 col-xs-12 col-sm-4">
    <form method="get" action="<?php echo get_the_permalink( $sb_search_page ); ?>">
      ...
      <label><?php echo esc_html( $title = empty($instance['title']) ? '' : apply_filters('widget_title', $instance['title']) ); echo adforest_returnEcho($is_ad_type); ?></label>
         <select class="category form-control submit_on_select" name="ad">
         <option label=""></option>
    <?php
		$conditions	=	array( 0 => __('Simple Ads','adforest'), '1' => __('Sticky Ads','adforest') );
