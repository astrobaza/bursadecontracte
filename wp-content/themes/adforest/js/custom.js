...
(function($) {
    ...
    if ($('#is_rtl').val() != "" && $('#is_rtl').val() == "1") {
        ...
        /* ======= sticky Carousel 1 ======= */
        $('.sticky-slider').owlCarousel({
            rtl: true,
            dots: false,
            loop: ($(".sticky-slider .item").length > 1) ? true : false,
            autoplay: true,
            autoplayHoverPause: true,
            autoplayTimeout: parseInt($('#auto_slide_time').val()),
            margin: -10,
        ...
        /* ======= sticky Carousel 2 ======= */
        $('.sticky-slider-1').owlCarousel({
            rtl: true,
            dots: ($(".sticky-slider-1 .item").length > 1) ? false : false,
            loop: ($(".sticky-slider-1 .item").length > 1) ? false : false,
            autoplay: true,
            autoplayHoverPause: true,
            margin: -10,
            responsiveClass: true, // Optional helper class. Add 'owl-reponsive-' + 'breakpoint' class to main element.
            ...
            responsive: {
                ...
                1000: {
                    items: $('#slider_item').val(),
                    nav: true,
                    loop: ($(".sticky-slider-1 .item").length > 4) ? true : false,
                }
            }
        });
        ...
        /* ======= sticky Carousel 2 ======= */
        $('.sticky-slider-5').owlCarousel({
            rtl: true,
            dots: ($(".sticky-slider-5 .item").length > 1) ? false : false,
            loop: ($(".sticky-slider-5 .item").length > 1) ? false : false,
            autoplay: true,
            autoplayHoverPause: true,
            margin: -10,
            responsiveClass: true, // Optional helper class. Add 'owl-reponsive-' + 'breakpoint' class to main element.
        ...
        /* ======= sticky  Carousel 3 ======= */
        $('.stickyslider-3').owlCarousel({
            rtl: true,
            dots: ($(".sticky-slider-3 .item").length > 1) ? false : false,
            loop: ($(".sticky-slider-3 .item").length > 1) ? true : false,
            autoplay: true,
            autoplayHoverPause: true,
            margin: 0,
            responsiveClass: true,
        ...
        $('.sticky-slider-1').owlCarousel({
            dots: ($(".sticky-slider-1 .item").length > 1) ? false : false,
            loop: ($(".sticky-slider-1 .item").length > 1) ? true : false,
            autoplay: true,
            autoplayHoverPause: true,
            autoplayTimeout: parseInt($('#auto_slide_time').val()),
            margin: -10,
    ...
    if ($('#ad_post_form').length > 0) {
        ...
        $('#ad_post_form').parsley().on('field:validated', function() {}).on('form:error', function() {
                $('.ad_errors').show();
    ...
    $('body').on('click', '.sb_page', function() {
        ...
        } else if ($(this).attr('ad_type') == 'sticky_ads') {
            this_action = 'my_sticky_ads';
        }
    ...
    $('#sb_sticky_ad').on('click', function() {
        $('#sb_loading').show();
        $.post(adforest_ajax_url, { action: 'sb_make_sticky', ad_id: $(this).attr('aaa_id'), }).done(function(response) {
            $('#sb_loading').hide();
            var get_r = response.split('|');
            if ($.trim(get_r[0]) == '1') {
                toastr.success(get_r[1], '', { timeOut: 4000, "closeButton": true, "positionClass": "toast-top-right" });
    ...
    $(document).on('click', '.sb_make_sticky_ad', function() {
        $('#sb_loading').show();
        $.post(adforest_ajax_url, { action: 'sb_make_sticky', ad_id: $(this).attr('data-aaa-id'), }).done(function(response) {
            $('#sb_loading').hide();
            var get_r = response.split('|');
            if ($.trim(get_r[0]) == '1') {
                toastr.success(get_r[1], '', { timeOut: 4000, "closeButton": true, "positionClass": "toast-top-right" });
    ...
    if ($('#ad_rating_form').length > 0) {
        $('#ad_rating_form').parsley().on('field:validated', function() {}).on('form:submit', function() {
    ...
    if ($('#rating_reply_form').length > 0) {
        ...
        $('#rating_reply_form').parsley().on('field:validated', function() {}).on('form:submit', function() {
            $('#sb_loading').show();
