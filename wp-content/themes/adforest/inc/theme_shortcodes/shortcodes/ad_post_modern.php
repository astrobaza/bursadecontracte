	...
	if($isCustom == 'no' )
	{
	  ...
	  $priceStaticHTML =  '<div class="row"><!-- Price  -->
	   ...
	   else
	   {
		...
		<div class="row">
		  <div class="col-md-12 col-lg-12 col-xs-12 col-sm-12">
			 <label class="control-label">'. __('Click the box below to ad photos', 'adforest' ) . ' <span class="required">*</span> <small>'.__( 'upload only jpg, png and jpeg files with a max file size of', 'adforest' ) ." " . $display_size  . '</small></label>
