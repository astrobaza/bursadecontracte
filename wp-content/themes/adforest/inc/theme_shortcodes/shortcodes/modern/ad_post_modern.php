...
if (!function_exists('ad_post_short_base_func')) {
    ...
    function ad_post_short_base_func($atts, $content = '') {
        ...
        if ($isCustom == 'no') {
            ...
            $priceTypeHTML = '<div class="row"><!-- Price  -->
		  <div class="col-md-12 col-lg-12 col-xs-12 col-sm-12">
		  ...
		  <div class="col-md-12 col-lg-12 col-xs-12 col-sm-12">
            ...
            if (isset($_sb_video_links) && !empty($_sb_video_links) && $_sb_video_links == 'no') {
                ...
                $video_html = '<div class="col-md-6 col-lg-6 col-xs-12 col-sm-12">
                                           ...
                                           <label class="control-label">' . __('Youtube Video Linkk', 'adforest') . '</label>
                                           <input data-parsley-required="false" data-parsley-error-message="' . $valid_text . '" data-parsley-pattern="/^.*(youtu.be\/|v\/|u\/\w\/|embed\/|watch\?v=|\&v=|\?v=)([^#\&\?]*).*/" class="form-control" type="text" name="ad_yvideo" id="ad_yvideo" value="' . $ad_yvideo . '">
...
var mymap = L.map(\'dvMap\').setView([' . $pin_lat . ', ' . $pin_long . '], 13);
	...
	markerz.on(\'dragend\', function (e) {
	  ...
	  document.getElementById(\'ad_map_long\').value = markerz.getLatLng().lng;
        ...
        if (in_array('woocommerce/woocommerce.php', apply_filters('active_plugins', get_option('active_plugins')))) {
            if (isset($adforest_theme['allow_sticky_on_ad']) && $adforest_theme['allow_stickyd_on_ad'] && $is_sticky_ad == 0 && ( get_user_meta(get_current_user_id(), '_sb_expire_ads', true) == '-1' || get_user_meta(get_current_user_id(), '_sb_expire_ads', true) >= date('Y-m-d') )) {
                if (get_user_meta(get_current_user_id(), '_sb_sticky_ads', true) == '-1' || get_user_meta(get_current_user_id(), '_sb_sticky_ads', true) > 0) {
                    ...
                    $simple_sticky_html = '<div class="select-package no-over-flow">
                              	<div class="no-padding col-md-12 col-lg-12 col-xs-12 col-sm-12">
                                 <div class="pricing-list">
                                    <div class="row">
                                       <div class="col-md-12 col-sm-12 col-xs-12">
        ...
        if (isset($terms_link) && $terms_link != "") {
            ...
            if (isset($terms_switch) && $terms_switch == 'show') {
                $tems_cond_field = '<div class="form-group adforest-ad-post-terms">
                                                <div class="row">
                                                              ...
                                                              <div class="skin-minimal">
                                                                 <ul class="list">
                                                                        <li>
                                                                               ...
                                                                               <label for="minimal-checkbox-1">' . __('I agree to', 'adforest') . ' <a href="' . $res['url'] . '" title="' . $res['title'] . '" target="' . $res['target'] . '">' . $terms_text . '</a></label>
                                                                        </li>
                                                                 </ul>
                                                              </div>
                                                       </div>
