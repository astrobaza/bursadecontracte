...
if (!class_exists('adforest_search_ad_simple_feature')) {
    ...
    class adforest_search_ad_simple_feature extends WP_Widget {
        ...
        public function widget($args, $instance) {
            ...
            global $adforest_theme;
            $widget_layout = adforest_search_layout();
            require trailingslashit(get_template_directory()) . 'template-parts/layouts/widgets/' . $widget_layout . '/simple_sticky.php';
        }
...
// Simple or sticky ad search
add_action('widgets_init', function() {
    register_widget('adforest_search_ad_simple_sticky');
});
if (!class_exists('adforest_search_ad_simple_sticky')) {

    class adforest_search_ad_simple_sticky extends WP_Widget {
        ...
        function __construct() {
            $widget_ops = array(
                'classname' => 'adforest_search_ad_simple_sticky',
                'description' => __('Only for search and single ad sidebar.', 'adforest'),
            );
            // Instantiate the parent object
            parent::__construct(false, __('Simple or sticky ad search', 'adforest'), $widget_ops);
        }
        ...
        public function form($instance) {
            if (isset($instance['title'])) {
                ...
                $title = esc_html__('Simple or sticky', 'adforest');
            }
            $this->adforect_widget_open($instance);
            ?>
            <p>
...
// stickyAds Widget
add_action('widgets_init', function() {
    register_widget('adforest_search_sticky_ad');
});
if (!class_exists('adforest_search_sticky_ad')) {

    class adforest_search_sticky_ad extends WP_Widget {
        ...
        function __construct() {
            $widget_ops = array(
                'classname' => 'adforest_search_sticky_ad',
                'description' => __('Only for search and single ad sidebar.', 'adforest'),
            );
            // Instantiate the parent object
            parent::__construct(false, __('Ad sticky', 'adforest'), $widget_ops);
        }
        ...
        public function widget($args, $instance) {
            ...
            <div class="panel panel-default">
                ...
                <div class="panel-collapse">
                    <div class="panel-body recent-ads">
                        <div class="sticky-slider-3 owl-carousel owl-theme owl-responsive-1000 owl-loaded">
                            <!-- sticky Ads -->
                            <?php
                            $f_args = array(
                                'post_type' => 'ad_post',
        ...
        public function form($instance) {
            ...
            if (isset($instance['title'])) {
                ...
                $title = esc_html__('Sticky Ads', 'adforest');
            }
            if (isset($instance['max_ads'])) {
                $max_ads = $instance['max_ads'];
            } else {
                                    ...
                                    <div class="recent-ads-container">
                                        ...
                                        <div class="recent-ads-list-content">
                                            <div class="recent-ads-list-title">
                                                <a href="<?php the_permalink(); ?>"><?php echo adforest_words_count(get_the_title(), 25); ?></a>
                                            </div>
                                            <ul class="recent-ads-list-location">
                                                <li><a href="javascript:void(0);"><?php echo adforest_words_count(get_post_meta(get_the_ID(), '_adforest_ad_location', true), 30); ?></a></li>
                                            </ul>
...
// Ad Locations widget
add_action('widgets_init', function() {
    register_widget('adforest_radius_search_locations');
});
